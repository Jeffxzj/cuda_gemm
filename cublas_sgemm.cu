// code from https://github.com/nicolaswilde/cuda-tensorcore-hgemm
...
int main () {
    ...
    // print CUBLAS version
    int cublasVer = CUBLAS_VERSION;
    int major = cublasVer / 10000;
    int minor = (cublasVer % 1000) / 100;
    int patch = cublasVer % 100;
